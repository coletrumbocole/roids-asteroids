...
import edu.byu.cs.superasteroids.database.OpenHelper;
...
public class MainActivity extends ActionBarActivityView implements IMainMenuView {
    ...
    private void initializeDatabase() {
        OpenHelper oh = new OpenHelper(getBaseContext());
        DAO.DAOSingletonInstance.setDb(oh.getWritableDatabase());
        // how to test for that? All db tests are anroid tests - becuase uses sqlite, which is android dependency.
    }
}
